...
module.exports = {
    ...
    plugins: [
        ...
        /*[
            'vuepress-plugin-coze',
            {
                ...
                masterKey: 'masterKey',
                //下面这些是可选的
                avatarPath: '你的说说头像 https://ooszy.cco.vin/img/blog-note/avatar-aurora.png',//说说头像url
                registerPath: '注册功能路径 /aurora-register', //自定义插件默认提供的注册页面路由，请在前面加上/
    ...
    head: [
        ...
        //这里放置你在阿里图标里的css链接，详细配置请看 https://aurora.xcye.xyz/style.html
        [
            "link",
            {
                rel: 'stylesheet',
